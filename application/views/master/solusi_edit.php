...
if(!$id){?>
<form method="post" name="frmEdit" action="<?php echo site_url('master/solusi_edit');?>">
<?php }else{?>
{datalist}
<form method="post" name="frmEdit" action="<?php echo site_url('master/solusi_edit/');?>/{id_solusi}">
<?php }?>
<h4><u>EDIT DATA MASTER SOLUSI</u></h4>
...
<table>
	<tr>
		<td>Id Solusi</td>
		<td>:</td>
		<td><input type="text" value="{id_solusi}" name="id" disabled="disabled" /></td>
	</tr>
	<tr>
		<td>Keterangan</td>
		<td>:</td>
