...
if(!$id){?>
<form method="post" name="frmEdit" action="<?php echo site_url('master/msipk_edit');?>">
<?php }else{?>
{datalist}
<form method="post" name="frmEdit" action="<?php echo site_url('master/msipk_edit/');?>/{id_ipk}">
<?php }?>
<h4><u>EDIT DATA MASTER NILAI</u></h4>
...
<table>
	<tr>
		<td>Id Nilai</td>
		<td>:</td>
		<td><input type="text" value="{id_ipk}" name="id" disabled="disabled" /></td>
	</tr>
	<tr>
		<td>Keterangan</td>
		<td>:</td>
