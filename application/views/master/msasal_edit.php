...
if(!$id){?>
<form method="post" name="frmEdit" action="<?php echo site_url('master/msasal_edit');?>">
<?php }else{?>
{datalist}
<form method="post" name="frmEdit" action="<?php echo site_url('master/msasal_edit/');?>/{id_asal}">
<?php }?>
...
<table>
	<tr>
		<td>Id Asal</td>
		<td>:</td>
		<td><input type="text" value="{id_asal}" name="id" disabled="disabled" /></td>
	</tr>
	<tr>
		<td>Keterangan</td>
		<td>:</td>
