...
<form method="post" name="frmEdit" action="<?php echo site_url('master/msekonomi_create');?>" onsubmit="javascript:return validate(this);">
<h4><u>TAMBAH MASTER EKONOMI</u></h4>
