...
<h4><u>DAFTAR MASTER ASAL</u></h4>
<?php if(isset($this->session->userdata['userid'])){ ?>
<a href="<?php echo site_url('master/msasal_create');?>">Tambah</a>
<?php }?>
<br/><br/>
<table style="border-collapse: collapse;">
	...
	<tr class="perrow">
		...
		<td>
			...
			<?php if($role == '1'){ ?>			
			<a href="<?php echo site_url('master/msasal_edit');?>/{id_asal}">Ubah</a>
			&nbsp;|&nbsp;
			<a href="<?php echo site_url('master/msasal_delete');?>/{id_asal}">Hapus</a>
			<?php } ?>
		</td>
	</tr>
	{/datalist}
