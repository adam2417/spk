...
if(!$id){?>
<form method="post" name="frmEdit" action="<?php echo site_url('master/masalah_edit');?>">
<?php }else{?>
{datalist}
<form method="post" name="frmEdit" action="<?php echo site_url('master/masalah_edit/');?>/{id_masalah}">
<?php }?>
<h4><u>EDIT DATA MASTER MASALAH</u></h4>
...
<table>
	<tr>
		<td>Id Masalah</td>
		<td>:</td>
		<td><input type="text" value="{id_masalah}" name="id" disabled="disabled" /></td>
	</tr>
	<tr>
		<td>Keterangan</td>
		<td>:</td>
