...
<h4><u>DAFTAR MASTER KELUARGA</u></h4>
<?php if(isset($this->session->userdata['userid'])){ ?>
<a href="<?php echo site_url('master/mskeluarga_create');?>">Tambah</a>
<?php }?>
<br/><br/>
<table style="border-collapse: collapse;">
	...
	<tr class="perrow">
		...
		<td>
			...
			<?php if($role == '1'){ ?>			
			<a href="<?php echo site_url('master/mskeluarga_edit');?>/{id_keluarga}">Ubah</a>
			&nbsp;|&nbsp;
			<a href="<?php echo site_url('master/mskeluarga_delete');?>/{id_keluarga}">Hapus</a>
			<?php } ?>
		</td>
	</tr>
	{/datalist}
