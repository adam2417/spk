...
<form method="post" name="frmEdit" action="<?php echo site_url('master/mskeluarga_create');?>" onsubmit="javascript:return validate(this);">
<h4><u>TAMBAH MASTER KELUARGA</u></h4>
