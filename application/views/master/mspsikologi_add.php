...
<form method="post" name="frmEdit" action="<?php echo site_url('master/mspsikologi_create');?>" onsubmit="javascript:return validate(this);">
<h4><u>TAMBAH MASTER PSIKOLOGI</u></h4>
