...
<form method="post" name="frmEdit" action="<?php echo site_url('master/mspribadi_create');?>" onsubmit="javascript:return validate(this);">
<h4><u>TAMBAH MASTER PRIBADI</u></h4>
